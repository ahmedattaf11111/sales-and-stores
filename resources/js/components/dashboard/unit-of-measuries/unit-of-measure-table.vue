<template>
  <div class="unit-of-measuries-container">
    <UnitOfMeasureForm
      @created="onCreated"
      @updated="onUpdated"
      :selectedUnitOfMeasure="selectedUnitOfMeasure"
    />
    <div v-if="!unitOfMeasures.length" class="no-data-found text-center">
      <div>
        {{ $t("NO_DATE_FOUND") }}
      </div>
      <button
        :disabled="!hasPermission('create unit_of_measure')"
        @click="onAddClicked"
        data-toggle="modal"
    ...
    <div v-else class="px-4">
      <div class="table-container">
        <div class="row">
          <div class="col-md-6">
            <div class="header">{{ $t("UNIT_OF_MEASURES_TABLE") }}</div>
          </div>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <span class="active">{{
                    unitOfMeasure.is_master == 1 ? $t("YES") : $t("NO")
                  }}</span>
                </td>
                <td>
                  <div class="dropdown commands">
                    ...
                    >
                      ...
                      >
                        <button
                          :disabled="!hasPermission('update unit_of_measure')"
                      ...
                      <div style="padding-top: 10px">
                        <button
                          :disabled="!hasPermission('delete unit_of_measure')"
