<template>
  <div class="purchase-invoice-container">
    ...
    <div v-if="!purchaseInvoices.length" class="no-data-found text-center">
      ...
      <button
        :disabled="!hasPermission('create purchase_return_invoice')"
        @click="onAddClicked()"
        data-toggle="modal"
                ...
                <td>
                  <div class="dropdown commands">
                    ...
                    >
                      ...
                      >
                        <button
                          :disabled="!hasPermission('update purchase_return_invoice')"
                      ...
                      >
                        <button
                          :disabled="!hasPermission('approve purchase_return_invoice')"
...
import PurchaseInvoiceForm from "./purchase-return-invoice-form.vue";
