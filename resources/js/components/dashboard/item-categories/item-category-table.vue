<template>
  <div class="item-categories-container">
    ...
    />
    <div v-if="!itemCategories.length" class="no-data-found text-center">
      <div>
        {{ $t("NO_DATE_FOUND") }}
      </div>
      <button
        :disabled="!hasPermission('create item-category')"
        @click="onAddClicked"
        data-toggle="modal"
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <tr
                class="value"
                v-for="(itemCategory, index) in itemCategories"
                :key="itemCategory.id"
              >
                ...
                <td>
                  <div class="dropdown commands">
                    ...
                    >
                      ...
                      >
                        <button
                          :disabled="!hasPermission('update item-category')"
                      ...
                      <div style="padding-top: 10px">
                        <button
                          :disabled="!hasPermission('delete item-category')"
