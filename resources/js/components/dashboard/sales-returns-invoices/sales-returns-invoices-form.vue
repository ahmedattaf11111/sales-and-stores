...
import saleReturnInvoiceItemClient from "../../../shared/http-clients/sale-invoice/sale-return-invoice-item-client";
...
export default {
  setup(props, context) {
    ...
    function addItemToInvoice() {
      ...
      saleReturnInvoiceItemClient
        .addItemToInvoice(form.invoice_item)
        .then(() => {
          context.emit("updated");
          getInvoiceItems();
          getItems();
    ...
    function getItems() {
      saleReturnInvoiceClient.getItems().then((response) => {
        data.items = response.data;
      });
    }
    function getStores() {
      saleReturnInvoiceClient.getStores().then((response) => {
        data.stores = response.data;
      });
    }
    function getInvoiceCategories() {
      saleReturnInvoiceClient.getInvoiceCategories().then((response) => {
