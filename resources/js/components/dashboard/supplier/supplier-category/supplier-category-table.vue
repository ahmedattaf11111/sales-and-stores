<template>
  <div class="supplier-categories-container">
    ...
    />
    <div v-if="!supplierCategories.length" class="no-data-found text-center">
      <div>
        {{ $t("NO_DATE_FOUND") }}
      </div>
      <button
        :disabled="!hasPermission('create supplier_category')"
        @click="onAddClicked"
        data-toggle="modal"
    ...
    <div v-else class="px-4">
      <div class="table-container">
        <div class="row">
          <div class="col-md-6">
            <div class="header">{{ $t("CATEGORIES_TABLE") }}</div>
          </div>
                ...
                <td>
                  <div class="dropdown commands">
                    ...
                    >
                      <div class="text">
                        <button
                          :disabled="!hasPermission('update supplier_category')"
