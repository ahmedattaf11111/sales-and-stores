...
export default {
  setup(props, context) {
      ...
      invoiceCategoryClient
        ...
        .then((response) => {
          ...
          context.emit("created", {
            ...response.data.invoice_category,
      ...
      invoiceCategoryClient
        ...
        .then((response) => {
          ...
          context.emit("updated", {
            ...response.data.invoice_category,
            added_by: props.selectedInvoiceCategory.added_by,
    ...
    function setForm() {
      ...
      v$.value.$reset();
      data.nameExist = false;
      form.name = props.selectedInvoiceCategory ? props.selectedInvoiceCategory.name : "";
      form.active = props.selectedInvoiceCategory
        ? Boolean(props.selectedInvoiceCategory.active)
        : true;
    }
    //Watchers
    watch(
